...
define('DOMAIN_URL', 'https://admin.andamanlottery.com'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
...
class Database
{
    ...
    private $db_name = "u424887645_and";    // Change as required
