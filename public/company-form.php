...
$sql_query = "SELECT * FROM company WHERE id = 1";
$db->sql($sql_query);
$res= $db->getResult();
...
if (isset($_POST['btnAdd'])) {
        ...
        if (!empty($name)) {
			if ($_FILES['image']['size'] != 0 && $_FILES['image']['error'] == 0 && !empty($_FILES['image'])) {
				...
				$sql = "UPDATE company SET `image`='" . $upload_image . "' WHERE id = 1";
				$db->sql($sql);
			}
                $sql = "UPDATE company SET name='$name',status=1 WHERE id=1";
                $db->sql($sql);
                        ...
                        <div class="row">
                            <div class="form-group">
                                <div class='col-md-4'>
                                    ...
                                    <label for="exampleInputEmail1">Company Name</label><?php echo isset($error['name']) ? $error['name'] : ''; ?>
                            ...
                            <div class="form-group">
                                <div class="form-group col-md-6">
                                    <div class="form-group">
                                        ...
                                        <p class="help-block"><img id="blah" src="<?php echo $res[0]['image']; ?>" style="height:50%;max-width:100%" /></p>
                                    </div>
                                </div>
                            </div>
