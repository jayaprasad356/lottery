...
$sql_query = "SELECT * FROM scheme WHERE id = 1";
$db->sql($sql_query);
$res= $db->getResult();
...
if (isset($_POST['btnAdd'])) {
			...
			if ($_FILES['image']['size'] != 0 && $_FILES['image']['error'] == 0 && !empty($_FILES['image'])) {
				...
				$sql = "UPDATE scheme SET `image`='" . $upload_image . "' WHERE id = 1";
				$db->sql($sql);
                ...
                if ($update_result == 1) {
                    $error['add_menu'] = "<section class='content-header'>
                                                     <span class='label label-success'>Success! Scheme From Image Updated..</span>
                                                      </section>";
                } else {
                        ...
                        <div class="row">
                            <div class="form-group">
                                <div class="form-group col-md-12">
                                    <div class="form-group">
                                        <label for="exampleInputFile">Scheme From Image</label>
...
<script>
    window.location('scheme_image.php');
</script>
