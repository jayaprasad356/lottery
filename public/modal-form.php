...
$sql_query = "SELECT * FROM modal WHERE id = 1";
$db->sql($sql_query);
$res= $db->getResult();
...
if (isset($_POST['btnAdd'])) {
			...
			if ($_FILES['image']['size'] != 0 && $_FILES['image']['error'] == 0 && !empty($_FILES['image'])) {
				...
				$sql = "UPDATE modal SET `image`='" . $upload_image . "' WHERE id = 1";
				$db->sql($sql);
                ...
                if ($update_result == 1) {
                    $error['add_menu'] = "<section class='content-header'>
                                                     <span class='label label-success'>Success! Modal Image Updated..</span>
                                                      </section>";
                } else {
                        ...
                        <div class="row">
                            <div class="form-group">
                                <div class="form-group col-md-12">
                                    <div class="form-group">
                                        <label for="exampleInputFile">Modal Image</label>
