                               ...
                               <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-footer">
                                        <div class="pull-left">
                                            <a  href="profile.php" class="btn btn-primary btn-flat"><i class="fa fa-user"></i>Profile</a>
                                        </div>
            ...
            <ul class="sidebar-menu" >
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="add-result.php"><i class="fa fa-plus"></i> Add Result</a></li>
                        ...
                        <li><a href="result_files.php"><i class="fa fa-sliders"></i>Manage Result File</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="marques.php"><i class="fa fa-angle-right"></i>Home page Marque</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="add-draw.php"><i class="fa fa-angle-right"></i> Add Draw</a></li>
                        <li><a href="draws.php"><i class="fa fa-angle-right"></i>Manage Draw</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="about_us.php">
                ...
                <li class="treeview">
                    <a href="modal_image.php">
                        <i class="fa fa-flag"></i>
                        <span>Modal Image</span>
                    </a>
                </li>
                <li class="treeview">
                    <a href="claim_image.php">
                        <i class="fa fa-flag"></i>
